Ext.define('MyKitchen.data.CountryState', {
    requires: [
        'MyKitchen.data.Init'
    ]
}, function() {
    Ext.ux.ajax.SimManager.register({
        '/MyKitchen/CountryState': {
            type: 'json',
            data: [
                { abbr: 'SZ', country: '中国', state: '苏州', description: '我现在工作的城市'},
                { abbr: 'HA', country: '中国', state: '淮安', description: '我出生的城市'},
                { abbr: 'BJ', country: '中国', state: '北京', description: '首都'},
