Ext.define('MyKitchen.view.thumbnails.Thumbnails', {
    ...
    itemTpl: [
        '<div class="thumbnail-icon-wrap icon-{[this.bkgnd[MyKitchen.profileName]]}">' +
            '<div class="thumbnail-icon {iconCls}"></div>' +
            '<tpl if="isNew">' +
                '<div {[this.styles[MyKitchen.profileName]]} ' +
