Ext.define('MyKitchen.view.grid.PagingController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.paging-grid',

    topicFmt:
        '<b><a href="http://sencha.com/forum/showthread.php?t={2}" target="_blank">{0}</a></b> <br/>' +
    ...
    renderLast: function (value, p, model) {
        ...
        return Ext.String.format('{0}<br/>by {1}',
            Ext.Date.dateFormat(value, 'Y年m月d日 g:i a'), model.get('lastposter'));
}
});
