 ...
 */
Ext.define('MyKitchen.view.form.CheckboxGroupForm', {
    ...
    otherContent: [{
        type: 'Controller',
        path: 'samples/view/form/CheckboxGroupFormController.js'
    }],
    //</example>
    ...
    items: [
        ...
        },
        {
            ...
            items: [
                ...
                {
                    xtype: 'checkboxgroup',
                    fieldLabel: 'Multi-Column (horizontal) 多列水平布局',
                    cls: 'x-check-group-alt',
                ...
                {
                    xtype: 'checkboxgroup',
                    fieldLabel: 'Multi-Column (vertical) 多列垂直布局',
                ...
                {
                    xtype: 'checkboxgroup',
                    fieldLabel: 'Multi-Column<br />(custom widths) 固定宽度，垂直布局',
                    cls: 'x-check-group-alt',
