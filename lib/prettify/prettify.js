                ...
                !prettyPrintedRe.test(className)) {
                    ...
                    if (!nested) {
                        ...
                        if (preformattedTagNameRe.test(cs.tagName)) {
                            ...
                            var whitespace = (
                            currentStyle ? currentStyle['whiteSpace'] : (defaultView && defaultView.getComputedStyle) ? defaultView.getComputedStyle(cs, null)
                                .getPropertyValue('white-space') : 0);
